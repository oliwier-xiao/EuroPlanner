...
// Przykładowe dane (docelowo z Supabase)
const MOCK_TRIPS = [
  ...
  return (
    <div className="p-4 md:p-8 space-y-8 relative">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-3xl font-bold text-white">Witaj, Podróżniku! 🌍</h1>
...
<button 
  ...
  >
    Zobacz wszystkie
        ...
        {/* PRAWA KOLUMNA: AKTYWNOŚĆ I STRUKTURA */}
